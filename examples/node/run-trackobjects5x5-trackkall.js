...
let config = {
    ...
    simsettings : {
        ...
        SAVEPATH : "../node/output/img/trackobstacles5by5-trackall"+process.argv[2],	// ... And save the image in this folder.
...
function logStats() {
        ...
        for( let cid of this.C.cellIDs() ){
            if (cid <= 1001){
                ...
                const fs = require('fs');
                fs.appendFileSync('../node/output/img/trackobstacles5by5-trackall'+process.argv[2]+'/position'+cid+'.txt', average_position+"\n");
            }
        }
        console.log("update")
}
