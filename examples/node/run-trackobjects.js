...
let config = {
    ...
    simsettings : {
        ...
        RUNTIME : 5000,
        CANVASCOLOR : "eaecef",
        CELLCOLOR : ["000000","000000", "A020F0"],
        ...
        SAVEPATH : "output/img/trackobstacles",	// ... And save the image in this folder.
...
function logStats() {
        ...
        for( let cid of this.C.cellIDs() ){
            if (cid == 1){
                ...
                const fs = require('fs');
                fs.appendFileSync('output/img/trackobstacles/position.txt', average_position+"\n");
