...
let config = {
    ...
    simsettings : {
        ...
        SAVEPATH : "../node/output/img/tracknoobstacles-track100"+process.argv[2],	// ... And save the image in this folder.
...
function logStats() {
        ...
        for( let cid of this.C.cellIDs() ){
            if (cid <= 101){
                ...
                const fs = require('fs');
                fs.appendFileSync('../node/output/img/tracknoobstacles-track100'+process.argv[2]+'/position'+cid+'.txt', average_position+"\n");
            }
